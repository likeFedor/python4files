...
#处理单个表,有合并行、列可直接用Cell（）来确定位置
    def excTable(self,r,c,t=0):	
        # 表格操作
        ...
        print (self.doc.Tables[t].Cell(r,c).Range.Text)
        self.wzy_file.write(self.doc.Tables[t].Cell(r,c).Range.Text+'\n')
    def saveAs(self):
...
#excel 测试代码
    '''
    xlsx=easyExcel(r'D:\PycharmProjects\pygit\python4file\1.xlsx')
